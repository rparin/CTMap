export default function EligibilityCriteria() {
    ...
    <p><b>Sex</b></p>
    <p><input type="radio" name="sex" id="all-sex" value="all-sex" /> <label htmlFor="all-sex">All</label></p>
    ...
    <p><b>Age</b></p>
    <p><input type="radio" name="age" id="ranges" /> <label htmlFor="ranges">Select Ranges</label></p>
